...
plot_rose(dartmouth_bears, "", labels = c("N", "E", "S", "W"))
```
:::
...
# sysfonts::font_add_google("Quicksand", regular.wt = 500)
# showtext::showtext_auto()

seg_highlight <- segments |>
  mutate(nwbw = group == 5) |>
  ggplot() +
...
seg_highlight <- segments |>
  ...
  theme(
    ...
    axis.text = element_blank(),
    panel.grid = element_blank(),
    # plot.title = element_text(size = 15, color = "#EBEBEB"),
    # plot.title = element_text(size = 16, family = "Quicksand", color = "#EBEBEB"),
  ) +
  bg_transparent()
seg_highlight
```
