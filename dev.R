...
# )
# 
# # center_angle_deg <- step_deg*5
# # lower_bound_deg <- step_deg*(4.5)
# # upper_bound_deg <- step_deg*5.5
# # 
# # # to radian
# # center_angle <- center_angle_deg
...
segments <- dart %>%
  ...
  arrange(tg) %>%
  ungroup() |> 
  # arrange(desc(nwbw)) |># TODO
  relocate(xend, yend, state, scaled_dx, scaled_dy, dx, dy,tg,nwbw, group) |>
